...
namespace IO.Swagger.Model
{
    ...
    public partial class GetMarketsRegionIdOrders200Ok :  IEquatable<GetMarketsRegionIdOrders200Ok>, IValidatableObject
    {
        ...
        public GetMarketsRegionIdOrders200Ok(long? orderId = default(long?), int? typeId = default(int?), long? locationId = default(long?), int? volumeTotal = default(int?), int? volumeRemain = default(int?), int? minVolume = default(int?), double? price = default(double?), bool? isBuyOrder = default(bool?), int? duration = default(int?), DateTime? issued = default(DateTime?), RangeEnum range = default(RangeEnum))
        {
