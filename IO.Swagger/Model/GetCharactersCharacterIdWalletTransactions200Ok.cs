...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdWalletTransactions200Ok :  IEquatable<GetCharactersCharacterIdWalletTransactions200Ok>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdWalletTransactions200Ok(long? transactionId = default(long?), DateTime? date = default(DateTime?), int? typeId = default(int?), long? locationId = default(long?), double? unitPrice = default(double?), int? quantity = default(int?), int? clientId = default(int?), bool? isBuy = default(bool?), bool? isPersonal = default(bool?), long? journalRefId = default(long?))
        {
