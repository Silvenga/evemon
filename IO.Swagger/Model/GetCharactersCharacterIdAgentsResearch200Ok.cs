...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCharactersCharacterIdAgentsResearch200Ok :  IEquatable<GetCharactersCharacterIdAgentsResearch200Ok>, IValidatableObject
    {
        /// <summary>
        ...
        public GetCharactersCharacterIdAgentsResearch200Ok(int? agentId = default(int?), int? skillTypeId = default(int?), DateTime? startedAt = default(DateTime?), float? pointsPerDay = default(float?), float? remainderPoints = default(float?))
        {
