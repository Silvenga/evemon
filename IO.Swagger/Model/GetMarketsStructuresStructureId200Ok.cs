...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetMarketsStructuresStructureId200Ok :  IEquatable<GetMarketsStructuresStructureId200Ok>, IValidatableObject
    {
        /// <summary>
        /// range string
        /// </summary>
        ...
        public GetMarketsStructuresStructureId200Ok(long? orderId = default(long?), int? typeId = default(int?), long? locationId = default(long?), int? volumeTotal = default(int?), int? volumeRemain = default(int?), int? minVolume = default(int?), double? price = default(double?), bool? isBuyOrder = default(bool?), int? duration = default(int?), DateTime? issued = default(DateTime?), RangeEnum range = default(RangeEnum))
        {
