...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCorporationsCorporationIdTitles200Ok :  IEquatable<GetCorporationsCorporationIdTitles200Ok>, IValidatableObject
    {
        /// <summary>
        /// role string
        /// </summary>
        ...
        public GetCorporationsCorporationIdTitles200Ok(int? titleId = default(int?), string name = default(string), List<RolesEnum> roles = default(List<RolesEnum>), List<GrantableRolesEnum> grantableRoles = default(List<GrantableRolesEnum>), List<RolesAtHqEnum> rolesAtHq = default(List<RolesAtHqEnum>), List<GrantableRolesAtHqEnum> grantableRolesAtHq = default(List<GrantableRolesAtHqEnum>), List<RolesAtBaseEnum> rolesAtBase = default(List<RolesAtBaseEnum>), List<GrantableRolesAtBaseEnum> grantableRolesAtBase = default(List<GrantableRolesAtBaseEnum>), List<RolesAtOtherEnum> rolesAtOther = default(List<RolesAtOtherEnum>), List<GrantableRolesAtOtherEnum> grantableRolesAtOther = default(List<GrantableRolesAtOtherEnum>))
        {
