...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdMailMailIdOk :  IEquatable<GetCharactersCharacterIdMailMailIdOk>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdMailMailIdOk(string subject = default(string), int? from = default(int?), DateTime? timestamp = default(DateTime?), List<GetCharactersCharacterIdMailMailIdRecipient> recipients = default(List<GetCharactersCharacterIdMailMailIdRecipient>), string body = default(string), List<long?> labels = default(List<long?>), bool? read = default(bool?))
        {
