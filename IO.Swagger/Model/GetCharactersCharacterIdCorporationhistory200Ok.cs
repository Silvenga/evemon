...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdCorporationhistory200Ok :  IEquatable<GetCharactersCharacterIdCorporationhistory200Ok>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdCorporationhistory200Ok(DateTime? startDate = default(DateTime?), int? corporationId = default(int?), bool? isDeleted = default(bool?), int? recordId = default(int?))
        {
