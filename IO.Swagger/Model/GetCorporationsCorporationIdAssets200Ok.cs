...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCorporationsCorporationIdAssets200Ok :  IEquatable<GetCorporationsCorporationIdAssets200Ok>, IValidatableObject
    {
        /// <summary>
        ...
        protected GetCorporationsCorporationIdAssets200Ok() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCorporationsCorporationIdAssets200Ok" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GetCorporationsCorporationIdAssets200Ok);
        }

        /// <summary>
        /// Returns true if GetCorporationsCorporationIdAssets200Ok instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCorporationsCorporationIdAssets200Ok to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCorporationsCorporationIdAssets200Ok input)
        {
            if (input == null)
                return false;
