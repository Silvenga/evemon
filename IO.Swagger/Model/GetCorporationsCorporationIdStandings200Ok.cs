...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCorporationsCorporationIdStandings200Ok :  IEquatable<GetCorporationsCorporationIdStandings200Ok>, IValidatableObject
    {
        /// <summary>
        /// from_type string
        /// </summary>
        ...
        protected GetCorporationsCorporationIdStandings200Ok() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCorporationsCorporationIdStandings200Ok" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GetCorporationsCorporationIdStandings200Ok);
        }

        /// <summary>
        /// Returns true if GetCorporationsCorporationIdStandings200Ok instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCorporationsCorporationIdStandings200Ok to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCorporationsCorporationIdStandings200Ok input)
        {
            if (input == null)
                return false;
