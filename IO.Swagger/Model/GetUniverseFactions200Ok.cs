...
namespace IO.Swagger.Model
{
    ...
    public partial class GetUniverseFactions200Ok :  IEquatable<GetUniverseFactions200Ok>, IValidatableObject
    {
        ...
        public GetUniverseFactions200Ok(int? factionId = default(int?), string name = default(string), string description = default(string), int? solarSystemId = default(int?), int? corporationId = default(int?), int? militiaCorporationId = default(int?), float? sizeFactor = default(float?), int? stationCount = default(int?), int? stationSystemCount = default(int?), bool? isUnique = default(bool?))
        {
