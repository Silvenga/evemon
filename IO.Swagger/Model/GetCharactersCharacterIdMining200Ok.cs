...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdMining200Ok :  IEquatable<GetCharactersCharacterIdMining200Ok>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdMining200Ok(DateTime? date = default(DateTime?), int? solarSystemId = default(int?), int? typeId = default(int?), long? quantity = default(long?))
        {
