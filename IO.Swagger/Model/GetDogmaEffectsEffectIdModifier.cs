...
namespace IO.Swagger.Model
{
    ...
    public partial class GetDogmaEffectsEffectIdModifier :  IEquatable<GetDogmaEffectsEffectIdModifier>, IValidatableObject
    {
        ...
        public GetDogmaEffectsEffectIdModifier(string func = default(string), string domain = default(string), int? modifiedAttributeId = default(int?), int? modifyingAttributeId = default(int?), int? effectId = default(int?), int? _operator = default(int?))
        {
