...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetAlliancesAllianceIdContacts200Ok :  IEquatable<GetAlliancesAllianceIdContacts200Ok>, IValidatableObject
    {
        /// <summary>
        /// contact_type string
        /// </summary>
        ...
        public GetAlliancesAllianceIdContacts200Ok(float? standing = default(float?), ContactTypeEnum contactType = default(ContactTypeEnum), int? contactId = default(int?), long? labelId = default(long?))
        {
