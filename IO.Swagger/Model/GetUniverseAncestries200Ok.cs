...
namespace IO.Swagger.Model
{
    ...
    public partial class GetUniverseAncestries200Ok :  IEquatable<GetUniverseAncestries200Ok>, IValidatableObject
    {
        ...
        public GetUniverseAncestries200Ok(int? id = default(int?), string name = default(string), int? bloodlineId = default(int?), string description = default(string), string shortDescription = default(string), int? iconId = default(int?))
        {
