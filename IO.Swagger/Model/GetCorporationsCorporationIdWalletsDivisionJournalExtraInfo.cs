...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo :  IEquatable<GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo" /> class.
        /// </summary>
        ...
        public GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo(long? locationId = default(long?), long? transactionId = default(long?), string npcName = default(string), int? npcId = default(int?), int? destroyedShipTypeId = default(int?), int? characterId = default(int?), int? corporationId = default(int?), int? allianceId = default(int?), int? jobId = default(int?), int? contractId = default(int?), int? systemId = default(int?), int? planetId = default(int?))
        {
        ...
        {
            return this.Equals(input as GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo);
        }

        /// <summary>
        /// Returns true if GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCorporationsCorporationIdWalletsDivisionJournalExtraInfo input)
        {
            if (input == null)
                return false;
