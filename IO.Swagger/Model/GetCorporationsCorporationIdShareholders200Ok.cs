...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationsCorporationIdShareholders200Ok :  IEquatable<GetCorporationsCorporationIdShareholders200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdShareholders200Ok(int? shareholderId = default(int?), ShareholderTypeEnum shareholderType = default(ShareholderTypeEnum), long? shareCount = default(long?))
        {
