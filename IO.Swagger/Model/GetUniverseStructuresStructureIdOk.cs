...
namespace IO.Swagger.Model
{
    ...
    public partial class GetUniverseStructuresStructureIdOk :  IEquatable<GetUniverseStructuresStructureIdOk>, IValidatableObject
    {
        ...
        public GetUniverseStructuresStructureIdOk(string name = default(string), int? solarSystemId = default(int?), int? typeId = default(int?), GetUniverseStructuresStructureIdPosition position = default(GetUniverseStructuresStructureIdPosition))
        {
