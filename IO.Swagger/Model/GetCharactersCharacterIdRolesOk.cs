...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdRolesOk :  IEquatable<GetCharactersCharacterIdRolesOk>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdRolesOk(List<RolesEnum> roles = default(List<RolesEnum>), List<RolesAtHqEnum> rolesAtHq = default(List<RolesAtHqEnum>), List<RolesAtBaseEnum> rolesAtBase = default(List<RolesAtBaseEnum>), List<RolesAtOtherEnum> rolesAtOther = default(List<RolesAtOtherEnum>))
        {
            this.Roles = roles;
