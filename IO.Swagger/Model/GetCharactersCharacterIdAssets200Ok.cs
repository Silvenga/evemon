...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCharactersCharacterIdAssets200Ok :  IEquatable<GetCharactersCharacterIdAssets200Ok>, IValidatableObject
    {
        /// <summary>
        ...
        public GetCharactersCharacterIdAssets200Ok(int? typeId = default(int?), int? quantity = default(int?), long? locationId = default(long?), LocationTypeEnum locationType = default(LocationTypeEnum), long? itemId = default(long?), LocationFlagEnum locationFlag = default(LocationFlagEnum), bool? isSingleton = default(bool?))
        {
