...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationsCorporationIdOk :  IEquatable<GetCorporationsCorporationIdOk>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdOk(string name = default(string), string ticker = default(string), int? memberCount = default(int?), int? ceoId = default(int?), int? allianceId = default(int?), string description = default(string), float? taxRate = default(float?), DateTime? dateFounded = default(DateTime?), int? creatorId = default(int?), string url = default(string), int? factionId = default(int?), int? homeStationId = default(int?), long? shares = default(long?))
        {
