...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationsCorporationIdContacts200Ok :  IEquatable<GetCorporationsCorporationIdContacts200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdContacts200Ok(float? standing = default(float?), ContactTypeEnum contactType = default(ContactTypeEnum), int? contactId = default(int?), bool? isWatched = default(bool?), long? labelId = default(long?))
        {
