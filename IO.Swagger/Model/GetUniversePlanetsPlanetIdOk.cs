...
namespace IO.Swagger.Model
{
    ...
    public partial class GetUniversePlanetsPlanetIdOk :  IEquatable<GetUniversePlanetsPlanetIdOk>, IValidatableObject
    {
        ...
        public GetUniversePlanetsPlanetIdOk(int? planetId = default(int?), string name = default(string), int? typeId = default(int?), GetUniversePlanetsPlanetIdPosition position = default(GetUniversePlanetsPlanetIdPosition), int? systemId = default(int?))
        {
