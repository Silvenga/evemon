...
namespace IO.Swagger.Model
{
    ...
    public partial class GetUniverseCategoriesCategoryIdOk :  IEquatable<GetUniverseCategoriesCategoryIdOk>, IValidatableObject
    {
        ...
        public GetUniverseCategoriesCategoryIdOk(int? categoryId = default(int?), string name = default(string), bool? published = default(bool?), List<int?> groups = default(List<int?>))
        {
