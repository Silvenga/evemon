...
namespace IO.Swagger.Model
{
    ...
    public partial class GetOpportunitiesGroupsGroupIdOk :  IEquatable<GetOpportunitiesGroupsGroupIdOk>, IValidatableObject
    {
        ...
        public GetOpportunitiesGroupsGroupIdOk(int? groupId = default(int?), string name = default(string), string description = default(string), string notification = default(string), List<int?> requiredTasks = default(List<int?>), List<int?> connectedGroups = default(List<int?>))
        {
