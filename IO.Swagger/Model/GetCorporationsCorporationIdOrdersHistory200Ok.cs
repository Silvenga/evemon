...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCorporationsCorporationIdOrdersHistory200Ok :  IEquatable<GetCorporationsCorporationIdOrdersHistory200Ok>, IValidatableObject
    {
        /// <summary>
        ...
        protected GetCorporationsCorporationIdOrdersHistory200Ok() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCorporationsCorporationIdOrdersHistory200Ok" /> class.
        /// </summary>
        ...
        public GetCorporationsCorporationIdOrdersHistory200Ok(long? orderId = default(long?), int? typeId = default(int?), int? regionId = default(int?), long? locationId = default(long?), RangeEnum range = default(RangeEnum), double? price = default(double?), int? volumeTotal = default(int?), int? volumeRemain = default(int?), DateTime? issued = default(DateTime?), bool? isBuyOrder = default(bool?), int? minVolume = default(int?), double? escrow = default(double?), int? duration = default(int?), StateEnum state = default(StateEnum), int? walletDivision = default(int?))
        {
        ...
        {
            return this.Equals(input as GetCorporationsCorporationIdOrdersHistory200Ok);
        }

        /// <summary>
        /// Returns true if GetCorporationsCorporationIdOrdersHistory200Ok instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCorporationsCorporationIdOrdersHistory200Ok to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCorporationsCorporationIdOrdersHistory200Ok input)
        {
            if (input == null)
                return false;
