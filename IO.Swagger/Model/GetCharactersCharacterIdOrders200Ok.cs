...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdOrders200Ok :  IEquatable<GetCharactersCharacterIdOrders200Ok>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdOrders200Ok(long? orderId = default(long?), int? typeId = default(int?), int? regionId = default(int?), long? locationId = default(long?), RangeEnum range = default(RangeEnum), double? price = default(double?), int? volumeTotal = default(int?), int? volumeRemain = default(int?), DateTime? issued = default(DateTime?), bool? isBuyOrder = default(bool?), int? minVolume = default(int?), double? escrow = default(double?), int? duration = default(int?), bool? isCorporation = default(bool?))
        {
