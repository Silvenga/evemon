...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdPlanetsPlanetIdExtractorDetails :  IEquatable<GetCharactersCharacterIdPlanetsPlanetIdExtractorDetails>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdPlanetsPlanetIdExtractorDetails(List<GetCharactersCharacterIdPlanetsPlanetIdHead> heads = default(List<GetCharactersCharacterIdPlanetsPlanetIdHead>), int? productTypeId = default(int?), int? cycleTime = default(int?), float? headRadius = default(float?), int? qtyPerCycle = default(int?))
        {
