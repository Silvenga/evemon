...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdSearchOk :  IEquatable<GetCharactersCharacterIdSearchOk>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GetCharactersCharacterIdSearchOk);
        }

        /// <summary>
        /// Returns true if GetCharactersCharacterIdSearchOk instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCharactersCharacterIdSearchOk to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCharactersCharacterIdSearchOk input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Structure != null &&
                    this.Structure.SequenceEqual(input.Structure)
                );
        }
