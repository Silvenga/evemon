...
namespace IO.Swagger.Model
{
    ...
    public partial class GetSovereigntyCampaigns200Ok :  IEquatable<GetSovereigntyCampaigns200Ok>, IValidatableObject
    {
        ...
        public GetSovereigntyCampaigns200Ok(int? campaignId = default(int?), long? structureId = default(long?), int? solarSystemId = default(int?), int? constellationId = default(int?), EventTypeEnum eventType = default(EventTypeEnum), DateTime? startTime = default(DateTime?), int? defenderId = default(int?), float? defenderScore = default(float?), float? attackersScore = default(float?), List<GetSovereigntyCampaignsParticipant> participants = default(List<GetSovereigntyCampaignsParticipant>))
        {
