...
namespace IO.Swagger.Model
{
    ...
    public partial class GetFwLeaderboardsVictoryPoints :  IEquatable<GetFwLeaderboardsVictoryPoints>, IValidatableObject
    {
        ...
        public GetFwLeaderboardsVictoryPoints(List<GetFwLeaderboardsYesterday1> yesterday = default(List<GetFwLeaderboardsYesterday1>), List<GetFwLeaderboardsLastWeek1> lastWeek = default(List<GetFwLeaderboardsLastWeek1>), List<GetFwLeaderboardsActiveTotal1> activeTotal = default(List<GetFwLeaderboardsActiveTotal1>))
        {
        ...
        public List<GetFwLeaderboardsYesterday1> Yesterday { get; set; }
        ...
        public List<GetFwLeaderboardsLastWeek1> LastWeek { get; set; }
        ...
        public List<GetFwLeaderboardsActiveTotal1> ActiveTotal { get; set; }
