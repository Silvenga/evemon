...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdBlueprints200Ok :  IEquatable<GetCharactersCharacterIdBlueprints200Ok>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdBlueprints200Ok(long? itemId = default(long?), int? typeId = default(int?), long? locationId = default(long?), LocationFlagEnum locationFlag = default(LocationFlagEnum), int? quantity = default(int?), int? timeEfficiency = default(int?), int? materialEfficiency = default(int?), int? runs = default(int?))
        {
