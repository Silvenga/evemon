...
namespace IO.Swagger.Model
{
    ...
    public partial class GetUniverseBloodlines200Ok :  IEquatable<GetUniverseBloodlines200Ok>, IValidatableObject
    {
        ...
        public GetUniverseBloodlines200Ok(int? bloodlineId = default(int?), string name = default(string), string description = default(string), int? raceId = default(int?), int? shipTypeId = default(int?), int? corporationId = default(int?), int? perception = default(int?), int? willpower = default(int?), int? charisma = default(int?), int? memory = default(int?), int? intelligence = default(int?))
        {
