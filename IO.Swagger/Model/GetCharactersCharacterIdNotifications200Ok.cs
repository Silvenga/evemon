...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdNotifications200Ok :  IEquatable<GetCharactersCharacterIdNotifications200Ok>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdNotifications200Ok(long? notificationId = default(long?), int? senderId = default(int?), SenderTypeEnum senderType = default(SenderTypeEnum), DateTime? timestamp = default(DateTime?), bool? isRead = default(bool?), string text = default(string), TypeEnum type = default(TypeEnum))
        {
