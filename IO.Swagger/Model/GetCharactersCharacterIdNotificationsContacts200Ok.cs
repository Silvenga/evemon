...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdNotificationsContacts200Ok :  IEquatable<GetCharactersCharacterIdNotificationsContacts200Ok>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdNotificationsContacts200Ok(int? notificationId = default(int?), DateTime? sendDate = default(DateTime?), float? standingLevel = default(float?), string message = default(string), int? senderCharacterId = default(int?))
        {
