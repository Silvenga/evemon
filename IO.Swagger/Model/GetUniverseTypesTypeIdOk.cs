...
namespace IO.Swagger.Model
{
    ...
    public partial class GetUniverseTypesTypeIdOk :  IEquatable<GetUniverseTypesTypeIdOk>, IValidatableObject
    {
        ...
        public GetUniverseTypesTypeIdOk(int? typeId = default(int?), string name = default(string), string description = default(string), bool? published = default(bool?), int? groupId = default(int?), int? marketGroupId = default(int?), float? radius = default(float?), float? volume = default(float?), float? packagedVolume = default(float?), int? iconId = default(int?), float? capacity = default(float?), int? portionSize = default(int?), float? mass = default(float?), int? graphicId = default(int?), List<GetUniverseTypesTypeIdDogmaAttribute> dogmaAttributes = default(List<GetUniverseTypesTypeIdDogmaAttribute>), List<GetUniverseTypesTypeIdDogmaEffect> dogmaEffects = default(List<GetUniverseTypesTypeIdDogmaEffect>))
        {
