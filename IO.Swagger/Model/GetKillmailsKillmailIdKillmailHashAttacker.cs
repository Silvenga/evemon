...
namespace IO.Swagger.Model
{
    ...
    public partial class GetKillmailsKillmailIdKillmailHashAttacker :  IEquatable<GetKillmailsKillmailIdKillmailHashAttacker>, IValidatableObject
    {
        ...
        public GetKillmailsKillmailIdKillmailHashAttacker(int? characterId = default(int?), int? corporationId = default(int?), int? allianceId = default(int?), int? factionId = default(int?), float? securityStatus = default(float?), bool? finalBlow = default(bool?), int? damageDone = default(int?), int? shipTypeId = default(int?), int? weaponTypeId = default(int?))
        {
