...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationsCorporationIdAlliancehistory200Ok :  IEquatable<GetCorporationsCorporationIdAlliancehistory200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdAlliancehistory200Ok(DateTime? startDate = default(DateTime?), int? allianceId = default(int?), bool? isDeleted = default(bool?), int? recordId = default(int?))
        {
