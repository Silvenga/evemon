...
namespace IO.Swagger.Model
{
    ...
    public partial class GetUniverseGroupsGroupIdOk :  IEquatable<GetUniverseGroupsGroupIdOk>, IValidatableObject
    {
        ...
        public GetUniverseGroupsGroupIdOk(int? groupId = default(int?), string name = default(string), bool? published = default(bool?), int? categoryId = default(int?), List<int?> types = default(List<int?>))
        {
