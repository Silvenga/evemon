...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationCorporationIdMiningExtractions200Ok :  IEquatable<GetCorporationCorporationIdMiningExtractions200Ok>, IValidatableObject
    {
        ...
        public GetCorporationCorporationIdMiningExtractions200Ok(long? structureId = default(long?), int? moonId = default(int?), DateTime? extractionStartTime = default(DateTime?), DateTime? chunkArrivalTime = default(DateTime?), DateTime? naturalDecayTime = default(DateTime?))
        {
