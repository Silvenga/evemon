...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetSovereigntyMap200Ok :  IEquatable<GetSovereigntyMap200Ok>, IValidatableObject
    {
        /// <summary>
        ...
        public GetSovereigntyMap200Ok(int? systemId = default(int?), int? allianceId = default(int?), int? corporationId = default(int?), int? factionId = default(int?))
        {
