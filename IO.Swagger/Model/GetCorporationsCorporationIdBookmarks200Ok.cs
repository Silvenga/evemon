...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationsCorporationIdBookmarks200Ok :  IEquatable<GetCorporationsCorporationIdBookmarks200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdBookmarks200Ok(int? bookmarkId = default(int?), int? creatorId = default(int?), int? folderId = default(int?), DateTime? created = default(DateTime?), string label = default(string), string notes = default(string), int? locationId = default(int?), GetCorporationsCorporationIdBookmarksItem item = default(GetCorporationsCorporationIdBookmarksItem), GetCorporationsCorporationIdBookmarksCoordinates coordinates = default(GetCorporationsCorporationIdBookmarksCoordinates))
        {
