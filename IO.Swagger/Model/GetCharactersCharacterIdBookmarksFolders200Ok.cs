...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdBookmarksFolders200Ok :  IEquatable<GetCharactersCharacterIdBookmarksFolders200Ok>, IValidatableObject
    {
        ...
        protected GetCharactersCharacterIdBookmarksFolders200Ok() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCharactersCharacterIdBookmarksFolders200Ok" /> class.
        /// </summary>
        /// <param name="folderId">folder_id integer (required).</param>
        /// <param name="name">name string (required).</param>
        public GetCharactersCharacterIdBookmarksFolders200Ok(int? folderId = default(int?), string name = default(string))
        {
            // to ensure "folderId" is required (not null)
            if (folderId == null)
            {
                throw new InvalidDataException("folderId is a required property for GetCharactersCharacterIdBookmarksFolders200Ok and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GetCharactersCharacterIdBookmarksFolders200Ok and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as GetCharactersCharacterIdBookmarksFolders200Ok);
        }

        /// <summary>
        /// Returns true if GetCharactersCharacterIdBookmarksFolders200Ok instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCharactersCharacterIdBookmarksFolders200Ok to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCharactersCharacterIdBookmarksFolders200Ok input)
        {
            if (input == null)
                return false;
