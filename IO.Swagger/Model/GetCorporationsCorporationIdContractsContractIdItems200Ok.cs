...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationsCorporationIdContractsContractIdItems200Ok :  IEquatable<GetCorporationsCorporationIdContractsContractIdItems200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdContractsContractIdItems200Ok(long? recordId = default(long?), int? typeId = default(int?), int? quantity = default(int?), int? rawQuantity = default(int?), bool? isSingleton = default(bool?), bool? isIncluded = default(bool?))
        {
