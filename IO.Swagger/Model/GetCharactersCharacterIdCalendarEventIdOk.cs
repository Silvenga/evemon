...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdCalendarEventIdOk :  IEquatable<GetCharactersCharacterIdCalendarEventIdOk>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdCalendarEventIdOk(int? eventId = default(int?), int? ownerId = default(int?), string ownerName = default(string), DateTime? date = default(DateTime?), string title = default(string), int? duration = default(int?), int? importance = default(int?), string response = default(string), string text = default(string), OwnerTypeEnum ownerType = default(OwnerTypeEnum))
        {
