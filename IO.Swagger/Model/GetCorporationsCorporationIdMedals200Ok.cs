...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCorporationsCorporationIdMedals200Ok :  IEquatable<GetCorporationsCorporationIdMedals200Ok>, IValidatableObject
    {
        /// <summary>
        ...
        public GetCorporationsCorporationIdMedals200Ok(int? medalId = default(int?), string title = default(string), string description = default(string), int? creatorId = default(int?), DateTime? createdAt = default(DateTime?))
        {
