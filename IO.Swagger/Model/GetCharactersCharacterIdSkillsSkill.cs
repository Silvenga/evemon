...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCharactersCharacterIdSkillsSkill :  IEquatable<GetCharactersCharacterIdSkillsSkill>, IValidatableObject
    {
        ...
        public GetCharactersCharacterIdSkillsSkill(int? skillId = default(int?), long? skillpointsInSkill = default(long?), int? trainedSkillLevel = default(int?), int? activeSkillLevel = default(int?))
        {
