...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationsCorporationIdStructures200Ok :  IEquatable<GetCorporationsCorporationIdStructures200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdStructures200Ok(long? structureId = default(long?), int? typeId = default(int?), int? corporationId = default(int?), int? systemId = default(int?), int? profileId = default(int?), DateTime? fuelExpires = default(DateTime?), List<GetCorporationsCorporationIdStructuresService> services = default(List<GetCorporationsCorporationIdStructuresService>), DateTime? stateTimerStart = default(DateTime?), DateTime? stateTimerEnd = default(DateTime?), DateTime? unanchorsAt = default(DateTime?), StateEnum state = default(StateEnum), int? reinforceWeekday = default(int?), int? reinforceHour = default(int?), int? nextReinforceWeekday = default(int?), int? nextReinforceHour = default(int?), DateTime? nextReinforceApply = default(DateTime?))
        {
