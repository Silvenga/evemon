...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationsCorporationIdContainersLogs200Ok :  IEquatable<GetCorporationsCorporationIdContainersLogs200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdContainersLogs200Ok(DateTime? loggedAt = default(DateTime?), long? containerId = default(long?), int? containerTypeId = default(int?), int? characterId = default(int?), long? locationId = default(long?), ActionEnum action = default(ActionEnum), PasswordTypeEnum? passwordType = default(PasswordTypeEnum?), int? typeId = default(int?), int? quantity = default(int?), int? oldConfigBitmask = default(int?), int? newConfigBitmask = default(int?), LocationFlagEnum locationFlag = default(LocationFlagEnum))
        {
