...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetFwStatsKills :  IEquatable<GetFwStatsKills>, IValidatableObject
    {
        /// <summary>
        ...
        public GetFwStatsKills(int? yesterday = default(int?), int? lastWeek = default(int?), int? total = default(int?))
        {
