...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationsCorporationIdRolesHistory200Ok :  IEquatable<GetCorporationsCorporationIdRolesHistory200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdRolesHistory200Ok(int? characterId = default(int?), DateTime? changedAt = default(DateTime?), int? issuerId = default(int?), RoleTypeEnum roleType = default(RoleTypeEnum), List<OldRolesEnum> oldRoles = default(List<OldRolesEnum>), List<NewRolesEnum> newRoles = default(List<NewRolesEnum>))
        {
