...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationsCorporationIdWalletsDivisionTransactions200Ok :  IEquatable<GetCorporationsCorporationIdWalletsDivisionTransactions200Ok>, IValidatableObject
    {
        ...
        public GetCorporationsCorporationIdWalletsDivisionTransactions200Ok(long? transactionId = default(long?), DateTime? date = default(DateTime?), int? typeId = default(int?), long? locationId = default(long?), double? unitPrice = default(double?), int? quantity = default(int?), int? clientId = default(int?), bool? isBuy = default(bool?), long? journalRefId = default(long?))
        {
