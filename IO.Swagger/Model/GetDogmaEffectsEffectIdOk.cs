...
namespace IO.Swagger.Model
{
    ...
    public partial class GetDogmaEffectsEffectIdOk :  IEquatable<GetDogmaEffectsEffectIdOk>, IValidatableObject
    {
        ...
        public GetDogmaEffectsEffectIdOk(int? effectId = default(int?), string name = default(string), string displayName = default(string), string description = default(string), int? iconId = default(int?), int? effectCategory = default(int?), int? preExpression = default(int?), int? postExpression = default(int?), bool? isOffensive = default(bool?), bool? isAssistance = default(bool?), bool? disallowAutoRepeat = default(bool?), bool? published = default(bool?), bool? isWarpSafe = default(bool?), bool? rangeChance = default(bool?), bool? electronicChance = default(bool?), int? durationAttributeId = default(int?), int? trackingSpeedAttributeId = default(int?), int? dischargeAttributeId = default(int?), int? rangeAttributeId = default(int?), int? falloffAttributeId = default(int?), List<GetDogmaEffectsEffectIdModifier> modifiers = default(List<GetDogmaEffectsEffectIdModifier>))
        {
