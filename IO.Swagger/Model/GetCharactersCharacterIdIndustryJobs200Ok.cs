...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCharactersCharacterIdIndustryJobs200Ok :  IEquatable<GetCharactersCharacterIdIndustryJobs200Ok>, IValidatableObject
    {
        /// <summary>
        /// status string
        /// </summary>
        ...
        protected GetCharactersCharacterIdIndustryJobs200Ok() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCharactersCharacterIdIndustryJobs200Ok" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GetCharactersCharacterIdIndustryJobs200Ok);
        }

        /// <summary>
        /// Returns true if GetCharactersCharacterIdIndustryJobs200Ok instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCharactersCharacterIdIndustryJobs200Ok to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCharactersCharacterIdIndustryJobs200Ok input)
        {
            if (input == null)
                return false;
