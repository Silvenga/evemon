...
namespace IO.Swagger.Model
{
    ...
    public partial class GetCorporationCorporationIdMiningObserversObserverId200Ok :  IEquatable<GetCorporationCorporationIdMiningObserversObserverId200Ok>, IValidatableObject
    {
        ...
        public GetCorporationCorporationIdMiningObserversObserverId200Ok(DateTime? lastUpdated = default(DateTime?), int? characterId = default(int?), int? recordedCorporationId = default(int?), int? typeId = default(int?), long? quantity = default(long?))
        {
