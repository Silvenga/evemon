...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCorporationsCorporationIdOutpostsOutpostIdService :  IEquatable<GetCorporationsCorporationIdOutpostsOutpostIdService>, IValidatableObject
    {
        /// <summary>
        /// service_name string
        /// </summary>
        ...
        public GetCorporationsCorporationIdOutpostsOutpostIdService(ServiceNameEnum serviceName = default(ServiceNameEnum), double? minimumStanding = default(double?), double? surchargePerBadStanding = default(double?), double? discountPerGoodStanding = default(double?))
        {
